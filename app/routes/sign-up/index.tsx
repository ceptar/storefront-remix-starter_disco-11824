          ...
          <div className="bg-white py-8 px-4 shadow sm: sm:px-10">
            ...
            <Form className="space-y-6" method="post">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center py-2 px-4 border border-transparent  shadow-sm text-sm font-fw400 text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
                >
                  {
                  // t
                  ('account.signUp')}
