    ...
    <>
      ...
      <Transition.Root show={mobileFiltersOpen} as={Fragment}>
        ...
        >
          <Transition.Child
            as={Fragment}
            enter="transition-all  transition-opacity ease-linear duration-300"
            enterFrom="opacity-0"
            enterTo="opacity-100"
            leave="transition-all  transition-opacity ease-linear duration-300"
          ...
          <div className="fixed inset-0 flex z-40">
            <Transition.Child
              as={Fragment}
              enter="transition-all  transition ease-in-out duration-300 transform"
              enterFrom="-translate-x-full"
              enterTo="translate-x-0"
              leave="transition-all  transition ease-in-out duration-300 transform"
