...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-primarytext shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-slate-950',
  {
    variants: {
      side: {
        ...
        right:
          'inset-y-0 right-0 h-full w-full sm:w-1/2 xl:w-1/3 border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right',
      },
    },
    defaultVariants: {
      side: 'right',
